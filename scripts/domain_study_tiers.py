...
VIRTUAL_DOMAIN_SCOPE: dict[str, str] = {
    ...
    "kubernetes-genai-agents": _prefix_scope("k8s-llm", "k8s-ai", "kgais-", "a30ag-", "bm-", "mais-"),
...
TIERS: dict[str, TierSpec] = {
    ...
    "linux-kernel": {
        "a_label": "ULK 核心脊骨（建议 solid）",
        "a": [
            "ulnk-kernel-introduction",
            "ulnk-processes",
            "ulnk-memory-addressing",
            "ulnk-system-calls",
            "ulnk-interrupts-exceptions",
            "ulnk-kernel-synchronization",
            "ulnk-process-scheduling",
            "ulnk-memory-management",
            "ulnk-process-address-space",
            "ulnk-page-frame-reclaiming",
            "ulnk-virtual-filesystem",
            "lkp2e-first-lkm-basics",
            "lkp2e-process-threads-task-struct",
            "lkp2e-kernel-sync-mutex-spinlock",
            "lknet-linux-network-stack",
            "lknet-netlink-sockets",
            "lknet-ipv4-receive-path",
            "lknet-ipv4-fib-routing",
            "lknet-network-namespaces",
        ],
        "b": [
            "ulnk-timing-measurements",
            "ulnk-block-device-drivers",
            "ulnk-page-cache",
            "ulnk-accessing-files",
            "ulnk-ext2-ext3-filesystems",
            "ulnk-io-architecture-drivers",
            "lkp2e-kernel-workspace-setup",
            "lkp2e-kernel-build-config",
            "lkp2e-kernel-build-install-boot",
            "lkp2e-lkm-advanced-practices",
            "lkp2e-memory-vas-internals",
            "lkp2e-kernel-kmalloc-slab",
            "lkp2e-kernel-vmalloc-oom",
            "lkp2e-cpu-scheduler-internals",
            "lkp2e-cpu-scheduler-cgroups-affinity",
            "lkp2e-kernel-sync-atomic-rcu",
            "lknet-icmp-v4-v6",
            "lknet-neighbour-arp-ndisc",
            "lknet-ipv6-stack",
            "lknet-netfilter-conntrack-nat",
            "lknet-layer4-tcp-udp-sockets",
            "lknet-advanced-routing-multicast",
            "lknet-ipsec-xfrm",
            "lknet-wireless-mac80211",
            "lknet-infiniband-rdma",
        ],
        "b_label": "I/O · 计时 · LKP · LKN 网络",
        "c_note": "signals/IPC/exec/启动 — learning + Query",
        "d_note": "—",
    },
    "systems-performance": {
        "a_label": "核心脊骨（建议 solid）",
    ...
    "ai-emerging-tech": {
        ...
        "c_note": "`aie-*`/`llm-*`/`llc-*`/`gaai-*`/`ml-*`/`nlp-*`/`vllm-*` 等 ingest 子页 — **learning + Query**；深度见各来源",
        "d_note": "—",
    },
    "technical-analysis": {
    ...
    "campus-wireless": {
        ...
        "c_note": "其余 cwna-* / cwdp-* / enwl-* / wng802-* / iwsd-* / dd802-* — **learning + Query**",
        "d_note": "—",
    },
    ...
    "network-architecture-extended": {
        "c_note": "杂项专著 / 5G / QoS / MRKI / dch2-* 等 — **learning + Query**；未归入其他 virtual 的 NA 页",
        "d_note": "索引 — 按需查阅",
    },
    ...
    "kubernetes-genai-agents": {
        ...
        "c_note": "其余 `k8s-llm-*`/`k8s-ai-*`/`mais-*`/`bm-*` — **learning + Query**",
        "d_note": "—",
    },
    ...
    "game-systems-design": {
        "a_label": "IGSD 核心（建议 solid）",
        "a": [
            "igsd-games-players-defined",
            "igsd-system-design-foundations",
            "igsd-attributes-mechanics",
            "igsd-attribute-numbers",
            "igsd-range-balancing",
            "igsd-exponential-diminishing-returns",
            "igsd-macrosystems-engagement",
            "igsd-probability-game-design",
        ],
        "b_label": "设计流程 / 测试（场景 solid）",
        "b": [
            "igsd-balance-testing",
            "igsd-analyzing-game-data",
            "gdp-six-elements-play-design",
        ],
        "c_note": "FOGD3 · TAOGD3 · 其余 igsd-* / gdp-* — **learning + Query**",
        "d_note": "—",
    },
}
